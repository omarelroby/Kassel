...
<head>
    <base href="">
    <title>Domains | Dashboard @yield('title')</title>
    ...
    <meta property="og:title" content="Domains | Dashboard @yield('title')" />
    <meta property="og:site_name" content="Domains | Dashboard @yield('title')" />
    ...
    <link href="{{url('/new/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="{{asset('new/assets/media/avatars/150-26.jpg')}}" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
