                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Login TO Admin Dashboard</h3>
                        </div>
                        @if (session('success'))
                        ...
                        @endif
                        <form class="form-horizontal form-simple" method="post" action="{{url('dashboard/login/post')}}">
                            @csrf
                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input type="text" name="email" class="form-control form-control-lg input-lg" placeholder="Email">
                            ...
                            <button type="submit" class="btn btn-brand btn-pill kt-login__btn-primary"><i class="ft-unlock"></i> Login</button>
                        </form>
                    </div>
                </div>
