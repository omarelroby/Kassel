...
<div class="page-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content d-flex justify-content-center align-items-center">
            ...
            <!-- Login form -->
            <form class="login-form" action="{{url('dashboard/admin/reset-password/post')}}" method="POST">
                @csrf()
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="form-group form-group-feedback form-group-feedback-left">
                            <input type="text" class="form-control" name="code" placeholder="الكود" required>
                            @error('code')
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block">إستعادة <i class="icon-circle-left2 ml-2"></i></button>
                        </div>
